...
import sys
sys.path.append("/home/data/qiao/FR-headc/TD-FCH/torchlight")
...
def get_parser():
    ...
    parser.add_argument('--work-dir', default='results/', help='the work folder for storing results')
    parser.add_argument('-model_saved_name', default='')
    parser.add_argument('--config', default='/home/data/qiao/TD-FCH/config/nturgbd-cross-view/rand_scale_bone.yaml',
    ...
    parser.add_argument('--num-worker', type=int, default=6, help='the number of worker for data loader')
    ...
    parser.add_argument('--fch', choices=['Metric-loss'], default=None,
                        help='mode of Metric loss')
    parser.add_argument('--ml-version', choices=['V0', 'V1', 'V2', "NO FN", "NO FP", "NO FN & FP"], default='V0',
                        help='different way to calculate the Metric loss')
    ...
    parser.add_argument('--start-ml-epoch', type=int, default=-1, help='epoch to optimize Metric loss')
    parser.add_argument('--w_metric_loss', type=float, default=0.25, help='weight of Metric loss')
    parser.add_argument('--fp-loss', type=float, default=1, help='weight of fn and fp Metric loss')
    ...
    parser.add_argument('--num-epoch', type=int, default=1, help='stop training in which epoch')
